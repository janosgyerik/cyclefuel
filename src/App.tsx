...
const App: React.FC = () => {
  ...
  const cycleData = {
    ...
    ovulation: {
      ...
      cardSummary: "Focus on: High-protein foods (lean meat and tofu), plenty of fresh vegetables and greens to boost fiber intake, zinc-rich foods.\n\nIdeal for high-intensity workouts.",
      focusOn: ["Zinc"],
    ...
    luteal: {
      ...
      otherItems: [],
      cardSummary: "Low energy, increased appetite.\n\nFocus on: High-fiber carbs, High-protein breakfasts, Magnesium-rich foods. Avoid: Processed junk food (especially before periods).",
